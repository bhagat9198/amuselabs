        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/dashboard" className="block">
            <div className="flex items-center gap-4" >
              ...
              {sidebarExpanded && <h1 className="text-2xl font-bold text-violet-500" >{appStore.siteName}</h1>}
            </div>
          </NavLink>
        </div>
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname.includes("dashboard") && "from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]"}`}>
                ...
                >
                  <div className="flex items-center">
                    <LuLayoutDashboard size={20} className={` shrink-0 fill-current ${pathname.includes('dashboard') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} />
